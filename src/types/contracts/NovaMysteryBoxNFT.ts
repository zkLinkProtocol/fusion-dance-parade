...
export interface NovaMysteryBoxNFTInterface extends utils.Interface {
  functions: {
    ...
    "burnNonces(address)": FunctionFragment;
    ...
    "safeMint(uint256,uint256,bytes)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "revokeRole"
      | "royaltyInfo"
      | "safeMint(uint256,uint256,bytes)"
  ...
  encodeFunctionData(
    functionFragment: "safeMint(uint256,uint256,bytes)",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>
...
export interface NovaMysteryBoxNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NovaMysteryBoxNFTInterface;
