...
export interface NovaMemeAxisNFTInterface extends utils.Interface {
  functions: {
...
export interface NovaMemeAxisNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NovaMemeAxisNFTInterface;
