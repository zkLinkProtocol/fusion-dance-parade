...
export const LoadingOverlay: FC<{ show?: boolean }> = ({ show }) => {
  return (
    <Transition
      ...
      leaveTo='opacity-0'
    >
      <div className='fixed inset-0 z-[9999] flex items-center justify-center overflow-hidden rounded-xl bg-white bg-opacity-5 backdrop-blur-sm transition-opacity'>
