...
interface IAllowListInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'getAccessMode', values: [string]): string;
  encodeFunctionData(functionFragment: 'getTokenDepositLimitData', values: [string]): string;
  encodeFunctionData(functionFragment: 'hasSpecialAccessToCall', values: [string, string, BytesLike]): string;
  encodeFunctionData(functionFragment: 'setAccessMode', values: [string, BigNumberish]): string;
  encodeFunctionData(functionFragment: 'setBatchAccessMode', values: [string[], BigNumberish[]]): string;
  encodeFunctionData(
    functionFragment: 'setBatchPermissionToCall',
    values: [string[], string[], BytesLike[], boolean[]],
  ): string;
  encodeFunctionData(functionFragment: 'setDepositLimit', values: [string, boolean, BigNumberish]): string;
  encodeFunctionData(functionFragment: 'setPermissionToCall', values: [string, string, BytesLike, boolean]): string;
...
export class IAllowList extends Contract {
  ...
  functions: {
    ...
    setAccessMode(_target: string, _accessMode: BigNumberish, overrides?: Overrides): Promise<ContractTransaction>;
  ...
  canCall(_caller: string, _target: string, _functionSig: BytesLike, overrides?: CallOverrides): Promise<boolean>;
  ...
  'getAccessMode(address)'(_target: string, overrides?: CallOverrides): Promise<number>;
  ...
  callStatic: {
    ...
    setAccessMode(_target: string, _accessMode: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    setBatchAccessMode(_targets: string[], _accessMode: BigNumberish[], overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    UpdateAccessMode(target: string | null, previousMode: null, newMode: null): EventFilter;
  ...
  estimateGas: {
    canCall(_caller: string, _target: string, _functionSig: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    getAccessMode(_target: string, overrides?: CallOverrides): Promise<BigNumber>;

    'getAccessMode(address)'(_target: string, overrides?: CallOverrides): Promise<BigNumber>;

    getTokenDepositLimitData(_l1Token: string, overrides?: CallOverrides): Promise<BigNumber>;

    'getTokenDepositLimitData(address)'(_l1Token: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    setAccessMode(_target: string, _accessMode: BigNumberish, overrides?: Overrides): Promise<BigNumber>;
    ...
    setBatchAccessMode(_targets: string[], _accessMode: BigNumberish[], overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getAccessMode(_target: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    'getAccessMode(address)'(_target: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    getTokenDepositLimitData(_l1Token: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    'getTokenDepositLimitData(address)'(_l1Token: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    setAccessMode(_target: string, _accessMode: BigNumberish, overrides?: Overrides): Promise<PopulatedTransaction>;
