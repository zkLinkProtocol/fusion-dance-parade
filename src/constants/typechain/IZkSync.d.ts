...
interface IZkSyncInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'setL2BootloaderBytecodeHash', values: [BytesLike]): string;
  encodeFunctionData(functionFragment: 'setL2DefaultAccountBytecodeHash', values: [BytesLike]): string;
  ...
  decodeFunctionResult(functionFragment: 'setVerifierParams', data: BytesLike): Result;
...
export class IZkSync extends Contract {
  ...
  functions: {
    ...
    setVerifier(_newVerifier: string, overrides?: Overrides): Promise<ContractTransaction>;

    'setVerifier(address)'(_newVerifier: string, overrides?: Overrides): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    proposeShadowUpgrade(_proposalHash: BytesLike, _proposalId: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    'securityCouncilUpgradeApprove(bytes32)'(_upgradeProposalHash: BytesLike, overrides?: CallOverrides): Promise<void>;

    setL2BootloaderBytecodeHash(_l2BootloaderBytecodeHash: BytesLike, overrides?: CallOverrides): Promise<void>;
    ...
    setL2DefaultAccountBytecodeHash(_l2DefaultAccountBytecodeHash: BytesLike, overrides?: CallOverrides): Promise<void>;
    ...
    'setVerifier(address)'(_newVerifier: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    ExecuteUpgrade(proposalId: BigNumberish | null, proposalHash: BytesLike | null, proposalSalt: null): EventFilter;
    ...
    NewL2BootloaderBytecodeHash(previousBytecodeHash: BytesLike | null, newBytecodeHash: BytesLike | null): EventFilter;
    ...
    NewVerifier(oldVerifier: string | null, newVerifier: string | null): EventFilter;

    NewVerifierParams(oldVerifierParams: null, newVerifierParams: null): EventFilter;
  ...
  estimateGas: {
    ...
    setL2BootloaderBytecodeHash(_l2BootloaderBytecodeHash: BytesLike, overrides?: Overrides): Promise<BigNumber>;
    ...
    setVerifier(_newVerifier: string, overrides?: Overrides): Promise<BigNumber>;

    'setVerifier(address)'(_newVerifier: string, overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    'setPendingGovernor(address)'(_newPendingGovernor: string, overrides?: Overrides): Promise<PopulatedTransaction>;

    setPorterAvailability(_zkPorterIsAvailable: boolean, overrides?: Overrides): Promise<PopulatedTransaction>;

    'setPorterAvailability(bool)'(_zkPorterIsAvailable: boolean, overrides?: Overrides): Promise<PopulatedTransaction>;
    ...
    setVerifier(_newVerifier: string, overrides?: Overrides): Promise<PopulatedTransaction>;

    'setVerifier(address)'(_newVerifier: string, overrides?: Overrides): Promise<PopulatedTransaction>;
    ...
    'storedBlockHash(uint256)'(_blockNumber: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
