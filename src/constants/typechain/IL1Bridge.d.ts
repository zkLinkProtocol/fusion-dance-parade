...
interface IL1BridgeInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [string, string, BytesLike, BigNumberish, BigNumberish, BigNumberish, BytesLike[]],
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: 'isWithdrawalFinalized', values: [BigNumberish, BigNumberish]): string;
...
export class IL1Bridge extends Contract {
  ...
  filters: {
    ClaimedFailedDeposit(to: string | null, l1Token: string | null, amount: null): EventFilter;

    DepositInitiated(from: string | null, to: string | null, l1Token: string | null, amount: null): EventFilter;

    WithdrawalFinalized(to: string | null, l1Token: string | null, amount: null): EventFilter;
  };
