...
export const rpcUrls = {
  [ChainId.ARBITRUM_NOVA]: [`https://lb.drpc.org/ogrpc?network=arbitrum-nova&dkey=${drpcId}`],
  [ChainId.ARBITRUM]: [`https://lb.drpc.org/ogrpc?network=arbitrum&dkey=${drpcId}`],
  [ChainId.AVALANCHE]: [`https://lb.drpc.org/ogrpc?network=avalanche&dkey=${drpcId}`],
  ...
  [ChainId.ETHEREUM]: [`https://lb.drpc.org/ogrpc?network=ethereum&dkey=${drpcId}`],
  ...
  [ChainId.HARMONY]: [`https://lb.drpc.org/ogrpc?network=harmony-0&dkey=${drpcId}`],
  ...
  [ChainId.MOONBEAM]: [`https://lb.drpc.org/ogrpc?network=moonbeam&dkey=${drpcId}`],
  [ChainId.MOONRIVER]: [`https://lb.drpc.org/ogrpc?network=moonriver&dkey=${drpcId}`],
  [ChainId.OPTIMISM]: [`https://lb.drpc.org/ogrpc?network=optimism&dkey=${drpcId}`],
  [ChainId.POLYGON]: [`https://lb.drpc.org/ogrpc?network=polygon&dkey=${drpcId}`],
  [ChainId.POLYGON_ZKEVM]: [`https://lb.drpc.org/ogrpc?network=polygon-zkevm&dkey=${drpcId}`],
  ...
  [ChainId.ZETACHAIN]: ['https://zetachain-mainnet-archive.allthatnode.com:8545'],
