...
const EIP3091_OVERRIDE = [ChainId.OPTIMISM, ChainId.BOBA, ChainId.BASE, ChainId.FILECOIN] as number[];
...
export const natives = Object.fromEntries(
  RAW.map((data): [ChainId, NativeCurrency] => [data.chainId, data.nativeCurrency]),
);
